<%@ Page Language="C#" MasterPageFile="~/adm/ADM.master" CodeFile="sitcheques.aspx.cs" Inherits="sitcheques" ValidateRequest="false" AutoEventWireup="true" Title="Untitled Page" %>
...
<div id="sitcheque" runat="server">
    <span class="TituloPagina">Situações de Cheques</span>
                    ...
                    <tr>
                        <td width="100%">
                            <table cellpadding="1" cellspacing="1" border="0" style="width: 1%;">
                                ...
                                <br/>
                                <tr align="left">
	                                <td class="LabelCampo" style="width:20%;">Situação:</td>
	                                <td style="width:80%;">
		                                <cc1:CustomTextBox 
