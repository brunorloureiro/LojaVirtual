<%@ Page Language="C#" MasterPageFile="~/adm/ADM.master" CodeFile="modulos.aspx.cs" Inherits="modulos" ValidateRequest="false" AutoEventWireup="true" Title="Untitled Page" %>
...
<div id="modulo" runat="server">
    <span class="TituloPagina">Módulos</span>
                    ...
                    <tr>
                        <td width="100%">
                            <table cellpadding="1" cellspacing="1" border="0" style="width: 1%;">
                                ...
                                <br/>
                                <tr align="left">
	                                <td class="LabelCampo" style="width:20%;">Módulo:</td>
	                                <td style="width:80%;">
		                                <cc1:CustomTextBox 
