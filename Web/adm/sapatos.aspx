<%@ Page Language="C#" MasterPageFile="~/adm/ADM.master" CodeFile="sapatos.aspx.cs" Inherits="sapatos" ValidateRequest="false" AutoEventWireup="true" Title="Untitled Page" %>
...
<asp:Content ID="Content3" ContentPlaceHolderID="ContentPlaceHolder2" Runat="Server">
    <span class="TituloPagina">Sapatos</span>
                    ...
                    <tr>
                        <td width="100%">
                            <table cellpadding="1" cellspacing="1" border="0" style="width: 1%;">
                                ...
                                <tr align="left">
	                                <td class="LabelCampo" style="width:1%;">Salto:</td>
	                                <td style="width:1%;">
	                                    <asp:DropDownList
	                                        ID          = "ddlsaltos"
	                                        AutoPostBack = "false"
                                ...
                                <tr align="left">
	                                <td class="LabelCampo" style="width:1%;">Bico:</td>
	                                <td style="width:1%;">
	                                    <asp:DropDownList
	                                        ID          = "ddlbicos"
	                                        AutoPostBack = "false"
