<%@ Page Language="C#" MasterPageFile="~/adm/ADM.master" CodeFile="entradas.aspx.cs" Inherits="entradas" ValidateRequest="false" AutoEventWireup="true" Title="Untitled Page" %>
...
<div id="entrada" runat="server">
    <span class="TituloPagina">Entrada de Peças no Estoque</span>
                    ...
                    <tr>
                        <td width="100%">
                            <table cellpadding="1" cellspacing="1" border="0" style="width: 1%;">
                                ...
                                <tr align="left">
	                                <td class="LabelCampo" style="width:20%;">Quantidade:</td>
	                                <td style="width:80%;">
		                                <cc1:CustomTextBox 
