<%@ Page Language="C#" MasterPageFile="~/adm/ADM.master" CodeFile="tiposdeproduto.aspx.cs" Inherits="tiposdeproduto" ValidateRequest="false" AutoEventWireup="true" Title="Untitled Page" %>
...
<asp:Content ID="Content3" ContentPlaceHolderID="ContentPlaceHolder2" Runat="Server">
     <span class="TituloPagina">Tipos de Produto</span>
                    ...
                    <tr>
                        <td width="100%">
                            <table cellpadding="1" cellspacing="1" border="0" style="width: 1%;">
                                ...
                                <br/>
                                <tr align="left">
	                                <td class="LabelCampo" style="width:20%;">Tipo:</td>
	                                <td style="width:80%;">
		                                <cc1:CustomTextBox 
                                ...
                                <tr align="left">
	                                <td class="LabelCampo" style="width:1%;">Gênero:</td>
	                                <td style="width:1%;">
	                                    <asp:DropDownList
	                                        ID          = "ddlgeneros"
	                                        AutoPostBack = "false"
