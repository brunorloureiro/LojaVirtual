<%@ Page Language="C#" MasterPageFile="~/adm/ADM.master" CodeFile="camisas.aspx.cs" Inherits="camisas" ValidateRequest="false" AutoEventWireup="true" Title="Untitled Page" %>
...
<asp:Content ID="Content3" ContentPlaceHolderID="ContentPlaceHolder2" Runat="Server">
    <span class="TituloPagina">Camisas</span>
                        ...
                        <td width="100%">
                            <table cellpadding="1" cellspacing="1" border="0" style="width: 1%;">
                               ...
                               &nbsp&nbsp <asp:CheckBox
			                                ...
			                                runat       = "server" />
			                          <span class="LabelRadio" colspan="2">Baby Look</span>
		                             </td>
                                </tr>
                                <tr align="left">
	                                <td colspan=2> 
		                             <asp:CheckBox
			                                ...
			                                style       = "margin-left: -04px;"
			                                runat       = "server" />
			                          <span class="LabelRadio" >Possui Estampa?</span>
	                                  <span class="LabelCampo" >&nbsp&nbsp Estampa:</span>
		                                <select id="estampa" style="color: black; font-family: Microsoft Sans Serif,MS Sans Serif; font-size: 8 pt;background-color: #fffacd; BORDER-RIGHT: #545558 1px solid; BORDER-LEFT: #545558 1px solid; BORDER-BOTTOM: #545558 1px solid; BORDER-TOP: #545558 1px solid;" runat="server">
										    <option value="">Sem Estampa</option>
										    <option value="A">Atrás</option> 
										    <option value="F">Frente</option> 
										    <option value="D">Frente/Atrás</option>
									    </select>
									  <span class="LabelCampo" >&nbsp&nbsp Manga:</span>
		                                <select id="manga" style="color: black; font-family: Microsoft Sans Serif,MS Sans Serif; font-size: 8 pt;background-color: #fffacd; BORDER-RIGHT: #545558 1px solid; BORDER-LEFT: #545558 1px solid; BORDER-BOTTOM: #545558 1px solid; BORDER-TOP: #545558 1px solid;" runat="server">
										    <option value="">Sem Manga</option>
										    <option value="C">Curta</option> 
										    <option value="L">Longa</option> 
									    </select>
									    <span class="LabelCampo" >&nbsp&nbsp Gola:</span>
		                                <select id="gola" style="color: black; font-family: Microsoft Sans Serif,MS Sans Serif; font-size: 8 pt;background-color: #fffacd; BORDER-RIGHT: #545558 1px solid; BORDER-LEFT: #545558 1px solid; BORDER-BOTTOM: #545558 1px solid; BORDER-TOP: #545558 1px solid;" runat="server">
										    <option value="N">Normal</option>
										    <option value="C">Cavada</option> 
                                ...
                                <tr>
                                    <td colspan=2><asp:Image ID="imgProduto1" runat="server" visible="false" style="margin-top: 15px; margin-bottom: 15px;" width="100px" heigth="50px" />
                                        ...
                                        <asp:Image ID="imgProduto3" runat="server" visible="false" style="margin-top: 15px; margin-bottom: 15px;" width="100px" heigth="50px"/>
                                    </td>
                                </tr>
                           </table>
                        </td>
