<%@ Page Language="C#" MasterPageFile="~/adm/ADM.master" CodeFile="bancos.aspx.cs" Inherits="bancos" ValidateRequest="false" AutoEventWireup="true" Title="Untitled Page" %>
...
<div id="banco" runat="server">
     <span class="TituloPagina">Bancos</span>
                    ...
                    <tr>
                        <td width="100%">
                            <table cellpadding="1" cellspacing="1" border="0" style="width: 1%;">
                                ...
                                <br/>
                                <tr align="left">
	                                <td class="LabelCampo" style="width:20%;">Banco:</td>
	                                <td style="width:80%;">
		                                <cc1:CustomTextBox 
                                ...
                                <tr align="left">
	                                <td class="LabelCampo" style="width:20%;">Sigla:</td>
	                                <td style="width:80%;">
		                                <cc1:CustomTextBox 
		                                    ClasseReferenciaCss="textmaiusculo" 
		                                    ID="txtsigla" 
		                                    runat="server" 
		                                    TipoDeCampo="Livre" 
                                            Largura="30" 
