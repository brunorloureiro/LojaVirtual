<%@ Page Language="C#" MasterPageFile="~/adm/ADM.master" CodeFile="submenus.aspx.cs" Inherits="submenus" ValidateRequest="false" AutoEventWireup="true" Title="Untitled Page" %>
...
<div id="submenu" runat="server">
    <span class="TituloPagina">SubMenus</span>
                    ...
                    <tr>
                        <td width="100%">
                            <table cellpadding="1" cellspacing="1" border="0" style="width: 1%;">
                                ...
                                <tr align="left">
	                                <td class="LabelCampo" style="width:1%;">Menu:</td>
	                                <td style="width:1%;">
	                                    <asp:DropDownList
	                                        ID          = "ddlmenus"
	                                        AutoPostBack = "false"
