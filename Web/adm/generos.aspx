<%@ Page Language="C#" MasterPageFile="~/adm/ADM.master" CodeFile="generos.aspx.cs" Inherits="generos" ValidateRequest="false" AutoEventWireup="true" Title="Untitled Page" %>
...
<div id="genero" runat="server">
    <span class="TituloPagina">Gêneros</span>
                    ...
                    <tr>
                        <td width="100%">
                            <table cellpadding="1" cellspacing="1" border="0" style="width: 1%;">
                                ...
                                <br/>
                                <tr align="left">
	                                <td class="LabelCampo" style="width:20%;">Gênero:</td>
	                                <td style="width:80%;">
		                                <cc1:CustomTextBox 
