<%@ Page Language="C#" MasterPageFile="~/adm/ADM.master" CodeFile="calcas.aspx.cs" Inherits="calcas" ValidateRequest="false" AutoEventWireup="true" Title="Untitled Page" %>
...
<asp:Content ID="Content3" ContentPlaceHolderID="ContentPlaceHolder2" Runat="Server">
    <span class="TituloPagina">Calças</span>
                    ...
                    <tr>
                        <td width="100%">
                            <table cellpadding="1" cellspacing="1" border="0" style="width: 1%;">
                                ...
                                <tr align="left">
	                                <td class="LabelCampo" style="width:1%;">Tipo:</td>
	                                <td style="width:1%;">
	                                    <asp:DropDownList
	                                        ID          = "ddltpcalcas"
	                                        AutoPostBack = "false"
	                                        ...
	                                        OnInit      = "carregaLista"
	                                        style="color: black; font-family: Microsoft Sans Serif,MS Sans Serif; font-size: 8 pt;background-color: #fffacd; BORDER-RIGHT: #545558 1px solid; BORDER-LEFT: #545558 1px solid; BORDER-BOTTOM: #545558 1px solid; BORDER-TOP: #545558 1px solid;"  />
	                                   <span class="LabelCampo" style="width:10%;">&nbsp Cintura:&nbsp</span>
	                                   <select id="cintura" style="color: black; font-family: Microsoft Sans Serif,MS Sans Serif; font-size: 8 pt;background-color: #fffacd; BORDER-RIGHT: #545558 1px solid; BORDER-LEFT: #545558 1px solid; BORDER-BOTTOM: #545558 1px solid; BORDER-TOP: #545558 1px solid;" runat="server">
