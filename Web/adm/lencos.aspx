<%@ Page Language="C#" MasterPageFile="~/adm/ADM.master" CodeFile="lencos.aspx.cs" Inherits="lencos" ValidateRequest="false" AutoEventWireup="true" Title="Untitled Page" %>
...
<asp:Content ID="Content3" ContentPlaceHolderID="ContentPlaceHolder2" Runat="Server">
    <span class="TituloPagina">Lenços/Cachecóis</span>
                    ...
                    <tr>
                        <td width="100%">
                            <table cellpadding="1" cellspacing="1" border="0" style="width: 1%;">
                                ...
                                <tr align="left">
	                                <td class="LabelCampo" style="width:1%;">Material:</td>
	                                <td style="width:1%;">
	                                    <asp:DropDownList
	                                        ID          = "ddlmateriais"
	                                        AutoPostBack = "false"
                                 ...
                                 <tr align="left">
	                                <td class="LabelCampo" style="width:10%;">Cor:</td>
	                                <td style="width:90%;"> 
		                              <cc1:CustomTextBox 
		                                    ClasseReferenciaCss="text" 
		                                    ID="txtcor" 
                                ...
                                <tr align="left">
	                                <td class="LabelCampo" style="width:10%;">Comprimento:</td>
	                                <td style="width:90%;"> 
		                                <cc1:CustomTextBox 
		                                    ClasseReferenciaCss="text" 
		                                    ID="txtcomprim" 
