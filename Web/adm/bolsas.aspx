<%@ Page Language="C#" MasterPageFile="~/adm/ADM.master" CodeFile="bolsas.aspx.cs" Inherits="bolsas" ValidateRequest="false" AutoEventWireup="true" Title="Untitled Page" %>
...
<asp:Content ID="Content3" ContentPlaceHolderID="ContentPlaceHolder2" Runat="Server">
    <span class="TituloPagina">Bolsas</span>
                        ...
                        <td width="100%">
                            <table cellpadding="1" cellspacing="1" border="0" style="width: 1%;">
                                ...
                                &nbsp&nbsp <asp:CheckBox
			                                ...
			                                runat       = "server" />
			                          <span class="LabelRadio" colspan="2">Possui Alça?</span>
		                             </td>
                                </tr>
                                <tr align="left">
