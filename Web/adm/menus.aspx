<%@ Page Language="C#" MasterPageFile="~/adm/ADM.master" CodeFile="menus.aspx.cs" Inherits="menus" ValidateRequest="false" AutoEventWireup="true" Title="Untitled Page" %>
...
<div id="menu" runat="server">
    <span class="TituloPagina">Menus</span>
                    ...
                    <tr>
                        <td width="100%">
                            <table cellpadding="1" cellspacing="1" border="0" style="width: 1%;">
                                ...
                                <tr align="left">
	                                <td class="LabelCampo" style="width:1%;">Módulo:</td>
	                                <td style="width:1%;">
	                                    <asp:DropDownList
	                                        ID          = "ddlmodulos"
	                                        AutoPostBack = "false"
