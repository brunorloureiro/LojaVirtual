<%@ Page Language="C#" MasterPageFile="~/adm/ADM.master" CodeFile="marcas.aspx.cs" Inherits="marcas" ValidateRequest="false" AutoEventWireup="true" Title="Untitled Page" %>
...
<asp:Content ID="Content3" ContentPlaceHolderID="ContentPlaceHolder2" Runat="Server">
    <span class="TituloPagina">Marcas</span>
                    ...
                    <tr>
                        <td width="100%">
                            <table cellpadding="1" cellspacing="1" border="0" style="width: 1%;">
                                ...
                                <br/>
                                <tr align="left">
	                                <td class="LabelCampo" style="width:20%;">Marca:</td>
	                                <td style="width:80%;">
		                                <cc1:CustomTextBox 
