<%@ Page Language="C#" MasterPageFile="~/adm/ADM.master" CodeFile="vicsecrets.aspx.cs" Inherits="vicsecrets" ValidateRequest="false" AutoEventWireup="true" Title="Untitled Page" %>
...
<asp:Content ID="Content3" ContentPlaceHolderID="ContentPlaceHolder2" Runat="Server">
    <span class="TituloPagina">Victória Secrets</span>
                    ...
                    <tr>
                        <td width="100%">
                            <table cellpadding="1" cellspacing="1" border="0" style="width: 1%;">
                                ...
                                <tr align="left">
	                                <td class="LabelCampo" style="width:1%;">Fragrância:</td>
	                                <td style="width:1%;">
	                                    <asp:DropDownList
	                                        ID          = "ddlfragrancias"
	                                        AutoPostBack = "false"
                                 ...
                                 <tr align="left">
	                                <td class="LabelCampo" style="width:1%;">Linha:</td>
	                                <td style="width:1%;">
	                                    <asp:DropDownList
	                                        ID          = "ddllinhas"
	                                        AutoPostBack = "false"
                                ...
                                <tr align="left">
	                                <td class="LabelCampo" style="width:10%;">Volume:</td>
	                                <td style="width:90%;"> 
		                              <cc1:CustomTextBox 
		                                    ClasseReferenciaCss="text" 
		                                    ID="txtvolume" 
