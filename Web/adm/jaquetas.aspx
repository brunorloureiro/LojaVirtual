<%@ Page Language="C#" MasterPageFile="~/adm/ADM.master" CodeFile="jaquetas.aspx.cs" Inherits="jaquetas" ValidateRequest="false" AutoEventWireup="true" Title="Untitled Page" %>
...
<asp:Content ID="Content3" ContentPlaceHolderID="ContentPlaceHolder2" Runat="Server">
    <span class="TituloPagina">Jaquetas</span>
                        ...
                        <td width="100%">
                            <table cellpadding="1" cellspacing="1" border="0" style="width: 1%;">
                                ...
                                &nbsp&nbsp <asp:CheckBox
			                                ...
			                                runat       = "server" />
			                          <span class="LabelRadio" colspan="2">Possui Gorro?</span>
			                   &nbsp&nbsp <asp:CheckBox
			                                CssClass    = "CamposLogin"
			                                id          = "chkfechicle"
			                                style       = "margin-left: -04px;"
			                                runat       = "server" />
			                          <span class="LabelRadio" colspan="2">Possui Fechiclé?</span>
		                             </td>
                                </tr>
                                <tr align="left">
	                                <td colspan=2> 
