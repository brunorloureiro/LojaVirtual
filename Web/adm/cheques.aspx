<%@ Page Language="C#" MasterPageFile="~/adm/ADM.master" CodeFile="cheques.aspx.cs" Inherits="cheques" ValidateRequest="false" AutoEventWireup="true" Title="Untitled Page" %>
...
<div id="cheque" runat="server">
    <span class="TituloPagina">Controle de Cheques</span>
                    ...
                    <tr>
                        <td width="100%">
                            <table cellpadding="1" cellspacing="1" border="0" style="width: 500px;">
                                <tr  align="left">
	                                <td class="LabelCampo" style="width:30%;">N° do Cheque:</td>
	                                <td style="width:70%;">
		                                <cc1:CustomTextBox 
                                ...
                                <br />
                                <tr align="left">
	                                <td class="LabelCampo" style="width:30%;">Banco:</td>
	                                <td style="width:70%;">
	                                    <asp:DropDownList
	                                        ID          = "ddlbancos"
	                                        AutoPostBack = "false"
                                ...
                                <tr align="left">
	                                <td class="LabelCampo" style="width:30%;">Tipo:</td>
	                                <td style="width:70%;"> 
